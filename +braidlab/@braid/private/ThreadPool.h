...
/*
  ...
  A simple implementation of a Thread Pool based on Jakob Progsch and
  Václav Zeman's implementation.
  ...
  ensuring that workers take up new tasks only as they complete
  previous tasks.
