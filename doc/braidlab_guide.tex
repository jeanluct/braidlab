...
\emph{geometric complexity} of a braid~\citep{Dynnikov2007}, is defined in
...
\lstinline{plot(l)} command.  We can convert from Dynnikov coordinates to
...
complexity, as defined by~\citet{Dynnikov2007}.
...
The \lstinline{entropy} method of the \lstinline{braid} class
