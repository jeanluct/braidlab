...
$\sigma_1\sigma_2^{-1}$ corresponds to a pseudo-Anosov isotopy class. %
\index{braid!pseudo-Anosov}%
...
\index{braid!pseudo-Anosov}%
can also achieve cycles: Figure~\ref{fig:efflinact3} is the plot produced by
\begin{lstlisting}[frame=single,framerule=0pt]
...
explained.  They seem to occur for \emph{any} braid, regardless of its %
...
experimental support for this in the form of the method \lstinline{reducing}: %
