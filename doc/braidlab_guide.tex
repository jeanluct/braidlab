...
\begin{center}
\subfigure[]{
  \includegraphics[height=.25\textheight]{testdata_trajs}
  \label{fig:testdata_trajs}
}\hspace{2em}
\subfigure[]{
  \includegraphics[height=.25\textheight]{testdata_braid}
...
\lstinline{plot(b)} to produce Figure~\ref{fig:testdata_braid}.
