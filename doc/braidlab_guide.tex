...
briefly.  The Burau matrix representation~\citep{Burau1936,Birman1975} %
...
B = [1x1 laurpoly]    [1x1 laurpoly]
    [1x1 laurpoly]    [1x1 laurpoly]
\end{lstlisting}
...
The \emph{tensor product} of two braids is the braid obtained by laying them
side-by-side \citep{KasselTuraev}: %
